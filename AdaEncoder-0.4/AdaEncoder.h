 ...
 * encoder behavior in a binary number called (appropriately enough) encoder.  Encoder has 8 bits, in the following
 * "positions":
 * Bits:      xx  xx  xx  xx
 * Position:  n/a  3   2   1
 * - Reading: 11 is either a bounce back to start, or the final reading:
 * 	- If encoder is xxxx0001, you have advanced CW.
 * 	- If encoder is xxxx0010, you have advanced CCW.
 *	- otherwise, you'd simply bounced.  No advance.
 *	- "encoder" is set to xxxx1111.
 * - Reading: 01 or 10:
 *	- If "encoder" had been reset to xxxx1111, set position 1 bits; ie, set it to 1101 or 1110, appropriately.
 *	- If "encoder" is xxxx00xy, you'd either bounced or moved to the next position, which means we get closer to detent.  No effect.
 * - Reading: 00:
 *	- Set position 2 bits: i.e., AND encoder with xxxx0011
 */
...
//#ifndef cppfix_h
//#include "../cppfix/cppfix.h"  // eliminates spurious "undefined reference to operator new" errors
//#endif

//  Some comment bits below copyright by the Arduino people.  I include it here so I can remember stuff as I code.
